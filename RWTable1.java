import java.io.*;
/***********************************************************************************************************************
 Программа, записывающая статистику из таблицы.
 ***********************************************************************************************************************
 JRE: 1.8
 ***********************************************************************************************************************
 Программа построчно считывает данные, разделенные символом ';'. 
 В данном случае программа предусматривает, что в таблице 3 колонки:
 (int)user_id;(int)count;(String)country
 Формат вывода программы в файл result.txt:
